      ...
      <div className="w-full flex">
        ...
        <div className="w-48 h-auto p-2 bg-gray-700/30 rounded-md m-4 shadow-md flex flex-col justify-center">
          <div className="w-full h-auto flex items-center justify-between">
            <div>
              <article className="text-xl text-gray-500 font-thin">Todays task</article>
              <div className="flex">
                <article className="text-sm text-slate-700">Last updated :</article>
                <article className="text-sm text-white font-thin">Recently</article>
              </div>
            </div>
            <span>
          ...
          <div className="w-[98%] h-[62%] border-[.5px] border-gray-700/60 mt-2 mb-2 place-self-center rounded-md">
            <div className="flex flex-row w-full h-auto justify-between">
              <article className="m-1 text-sm text-gray-400">Task point</article>
              <article className="m-1 text-sm text-gray-400">{homeData.hour<10?"0":""}{homeData.hour} {homeData.minute<10?"0":""}{homeData.minute} hrs</article>
            </div> 
            <div className="w-full p-1 flex items-center">
              ...
              <div className="h-auto flex items-center p-1">
                <article className="text-wrap text-[10px] text-slate-300">Edit network design</article>
                <article className="text-[9px] text-gray-600/50">Low impact</article>
              </div>
              
            </div>
            <div className="w-full h-auto m-0 mt-1">
              <span className="flex items-center text-sm m-0 ml-4">
                <sup className="text-orange-500 text-sm">{homeInputs.homeRange}</sup>
                <article className="text-gray-600 text-lg m-0">/</article>
                <sub className="text-[9px] text-white">20</sub>
              </span>
              <span className="w-full h-auto">
               <input type="range" max={20} min={0} name="homeRange" value={homeInputs.homeRange} id="" className="w-full" onChange={(e)=>handleInputsUpdate(e)}/> 
              </span>
              
            </div>
            
          </div>
          <button className="w-full h-8 border-2 border-orange-500/70 rounded-xl hover:bg-orange-500/90  hover:transition-all">Feedback</button>
        </div>
      </div>
    </div>
  );
